<template>
  ...
  label="小姐" />
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong1DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong2MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong3MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong3DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong4MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong4DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox1MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox1DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
            <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox2MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox2DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
             <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox3MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox3DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
            <q-input
   ...
   <q-card style="overflow: hidden;">
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox4MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBox4DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
            <q-input
  ...
  <div>
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdongCustom1MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdongCustom1DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBoxCustom1MainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="lunchBoxCustom1DrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
          <q-input
  ...
  <!-- 訂單區 -->
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong1EditMainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong1EditDrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong2EditMainArbitrarily"
    label="主餐任意搭配"
    min="0"
    />
    <q-input
    ...
    :input-style="{fontSize:'20px'}"
    style="width:130px"
    v-model="bangdong2EditDrinkArbitrarily"
    label="飲料任意搭配"
    min="0"
    />
    <q-input
  ...
  <q-dialog v-model="editDialog6" full-width>
    ...
    <div class="q-gutter-xs row items-start justify-center" id="lunchbox1Edit">
      <div v-for="(lunchBox4EditMain, index) in lunchBox4EditMains" :key="index">
        ...
        <q-input v-model="lunchBox4EditMain.quantity" :label="lunchBox4EditMain.name" outlined type="number"
          :input-style="{ fontSize: '20px', margin: '0' }" :label-style="{ fontSize: '20px' }" style="width: 130px;"
          min="0"/>
        ...
        <div v-for="(lunchBox4EditDrink, drinkIndex) in lunchBox4EditMain.drinks" :key="drinkIndex">
          <q-input v-model="lunchBox4EditDrink.quantity" :label="lunchBox4EditDrink.name" outlined type="number"
            :input-style="{ fontSize: '20px', margin: '0' }" :label-style="{ fontSize: '20px' }" style="width: 130px;"
            min="0"/>
        </div>
      </div>
    ...
    <div class="row q-mr-lg q-mb-auto  flex-wrap" style="width: 100%; gap: 16px; margin-top:5px;  margin-left:35px; ">
      ...
      <div class="row items-center">
        <q-item v-for="(lunchBox4EditSideDish, index) in lunchBox4EditSideDishes" :key="index" class="flex-auto "
          style="margin: 0; padding: 0;">
          <q-input v-model="lunchBox4EditSideDish.quantity" :label="lunchBox4EditSideDish.name" outlined type="number"
            :input-style="{ fontSize: '20px', margin: '0' }" :label-style="{ fontSize: '20px' }" style="width: 130px;"
            min="0"/>
        </q-item>
      </div>
