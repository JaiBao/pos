...
const rows = [
  {
    ...
    time2: '10:30',
    calories:
      '炒雞潤餅＊12 <div class="br-container"><br></div> 炸蝦潤餅＊12  <div class="br-container"><br></div>呱呱卷＊12<div class="br-container"><br></div>滷肉潤餅＊12<div class="br-container"><br></div>薯泥潤餅＊12'
  },
  {
    sort: 2,
    name: '1536',
