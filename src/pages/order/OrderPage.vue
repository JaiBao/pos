  ...
  >
    <template v-slot:append>
      ...
      >
        ...
        >
          <q-date v-model="personForm.checkDate" today-btn @input="hideDatePicker">
            <div class="row items-center justify-end">
              <q-btn label="確定" color="primary" flat @click="hideDatePicker" />
            </div>
          </q-date>
        </q-popup-proxy>
      </q-icon>
              ...
              <td>
                ...
                >
                  <q-popup-proxy
                    ...
                    style="width: 800px"
                  >
                    <q-date v-model="personForm.getDate" style="width: 800px" @input="$emit('close')">
            ...
            <tr>
              ...
              <td>
                ...
                <div
                  ...
                  "
                >
                  <q-radio v-model="personForm.gender" val="17" label="Mr" />
                  <q-radio v-model="personForm.gender" val="18" label="Ms" />
                </div>
              </td>
    ...
    <div class="row menu text-left" data-order-panel>
      ...
      <q-btn
        ...
        class="personBtn"
      />
      <q-btn @click="openbangdong" color="blue">便當</q-btn>

      <q-btn color="blue" label="盒餐" @click="openlunchBox" />
      <q-btn color="blue" label="單點" @click="opensolo" />
      <q-btn color="blue" label="客製便當" @click="openCustomBangdong" />
      <q-btn color="blue" label="客製盒餐" @click="openCustomLunchBox" />
      <q-btn
        color="green"
        @click="addOrder"
        :disabled="isSubmitting"
      ...
      <q-dialog v-model="showbangdong1">
        <q-card
          class="items-start word-break"
          id="bangdongcard"
          style="padding: 0; margin: 0"
        >
          <div :class="color1" style="width: 100%; padding: 0; margin: 0">
          ...
          <!-- 飲料 -->
          <div :class="color2" style="width: 100%; padding: 0; margin: 0">
          ...
          <!-- 總計 -->
          <div style="width: 100%; padding: 0; margin: 0" :class=color2 >
      ...
      <q-dialog v-model="showbangdong2">
        <q-card
          class="row items-start word-break"
          id="bangdongcard"
          style="padding: 0; margin: 0"
        >
          <div :class="color1" style="width: 100%; padding: 0; margin: 0">
          ...
          <!-- 總計 -->
          <div style="width: 100%; padding: 0; margin: 0" :class="color1">
            ...
            <div class="row items-center">
              ...
              >
                <q-input
                  ...
                  :label="bangdongVegetarian1Main.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
          ...
          <div style="width: 100%; padding: 0; margin: 0" :class="color1">
            ...
            <div class="row justify-end" style="width: 100%">
              ...
              <q-btn
                color="red"
                label="取消"
                @click="showbangdongVegetarian1 = false"
                class="q-mt-md"
              />
            </div>
          </div>
            ...
            <div class="row items-center">
              ...
              >
                <q-input
                  ...
                  :label="bangdongVegetarian2Main.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
          ...
          <div style="width: 100%; padding: 0; margin: 0" :class="color1">
            ...
            <div class="row justify-end" style="width: 100%">
              ...
              <q-btn
                color="red"
                label="取消"
                @click="showbangdongVegetarian2 = false"
                class="q-mt-md"
              />
            </div>
          </div>
      ...
      <q-dialog v-model="showlunchBox1" full-width>
        ...
        <q-card style="overflow-x: hidden">
          <div
            class="q-gutter-xs row items-start justify-center"
            id="lunchbox1"
          >
            <div
              v-for="(lunchBox1Main, index) in lunchBox1Mains"
              :key="index"
      ...
      <q-dialog v-model="showlunchBox2" full-width>
        ...
        <q-card style="overflow-x: hidden">
          ...
          >
            <div
              v-for="(lunchBox2Main, index) in lunchBox2Mains"
              :key="index"
              :class="getBackgroundColor(index)"
            >
      ...
      <q-dialog v-model="showlunchBox3" full-width>
        ...
        <q-card style="overflow-x: hidden">
          ...
          >
            <div
              v-for="(lunchBox3Main, index) in lunchBox3Mains"
              :key="index"
              :class="getBackgroundColor(index)"
            >
      ...
      <q-dialog v-model="showlunchBox4" full-width>
        ...
        <q-card style="overflow-x: hidden">
          ...
          >
            <div
              v-for="(lunchBox4Main, index) in lunchBox4Mains"
              :key="index"
              :class="getBackgroundColor(index)"
            >
      ...
      <q-dialog v-model="showbangdongCustom1" class="lunchBoxdailog">
        <q-card
          class="q-gutter-md row items-start word-break"
          id="bangdongcard"
        >
          <!-- 主餐 -->
          <div :class="color1" style="width: 100%; padding: 0; margin: 0">
      ...
      <q-dialog v-model="showLunchBoxCustom1" class="lunchBoxdailog" full-width>
        ...
        <q-card style="overflow-x: hidden">
          ...
          >
            ...
            >
              <h5 style="margin: 0; padding: 0">
                {{ lunchBoxCustom1Main.name }}
              </h5>
              <q-input
                min="0"
                v-model.number="lunchBoxCustom1Main.quantity"
                :label="lunchBoxCustom1Main.name"
                outlined
                type="number"
                :input-style="{ fontSize: '20px', margin: '0' }"
                :label-style="{ fontSize: '20px' }"
      ...
      <div class="col p-4 slider" data-order-lists>
          ...
          <div class="col-12">
            <div class="q-pa-xs">
              ...
              >
                <template v-slot:top>
                  <q-toolbar>
                    <q-toolbar-title class="row flex-around"
                      ><h3 style="margin: 0">訂單</h3>
                      <div>
                        <q-select
                          outlined
                    ...
                    <h class="row tableMember">
                      <p v-if="personForm.memberId">
                        會員編號: {{ personForm.memberId }}
                      </p>
                      <p v-if="personForm.name">
                        訂購人: {{ personForm.name }}
                      </p>
                      <p v-if="personForm.tel">
                        訂購人電話: {{ personForm.tel }}
                      </p>
                      <p v-if="personForm.hometel">
                        訂購人室內電話: {{ personForm.prefix }}
                ...
                <template #body="props">
                  <q-tr :props="props">
                    ...
                    <q-td
                      ...
                      <!-- <div v-for="(mainInput, index) in props.row.mainInputs" :key="index" style="text-align: center;font-size:20px">
              <input type="hidden" :name="mainInput.name" v-model="mainInput.value"
              >
            </div>
            <div v-for="(drinkInput, index) in props.row.drinkInputs" :key="index" style="text-align: center;font-size:20px">
              <input type="hidden" :name="drinkInput.name" v-model="drinkInput.value"
              >
            </div>
            <div v-for="(bentoInput, index) in props.row.bentoInputs" :key="index" style="text-align: center;font-size:20px">
              <input type="hidden" :name="bentoInput.name" v-model="bentoInput.value"
              >
            </div>
            <div v-for="(sidedishInput, index) in props.row.sidedishInputs" :key="index" style="text-align: center;font-size:20px">
              <input type="hidden" :name="sidedishInput.name" v-model="sidedishInput.value"
              >
            </div> -->
                    </q-td>
              ...
              <div class="row items-center">
                ...
                >
                  <q-input
                    ...
                    :label="bangdongVegetarian1EditMain.name"
                    outlined
                    type="number"
                    :input-style="{ fontSize: '20px', margin: '0' }"
                    :label-style="{ fontSize: '20px' }"
        ...
        <q-dialog v-model="editDialogV2">
          ...
          >
              ...
              <div class="row items-center">
                ...
                >
                  <q-input
                    ...
                    :label="bangdongVegetarian2EditMain.name"
                    outlined
                    type="number"
                    :input-style="{ fontSize: '20px', margin: '0' }"
                    :label-style="{ fontSize: '20px' }"
            ...
            <!-- 飲料 -->
            <div>
              <h5 :class="color2" style="width: 100%; padding: 0; margin: 0">
                {{ bangdongVegetarian2DrinkName }}
              </h5>
              <div class="row items-center">
                <q-item
        ...
        <q-dialog v-model="editDialog5" full-width>
          <q-card>
            ...
            >
              ...
              >
                <h5 style="margin: 0; padding: 0">
                  {{ lunchBox1EditMain.name }}
                </h5>
                <q-input
                  v-model.number="lunchBox1EditMain.quantity"
                  :label="lunchBox1EditMain.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
                ...
                />
                <h5 style="margin: 0; padding: 0">
                  {{ lunchBox1EditDrinkName }}
                </h5>
                <div
                  v-for="(
                    lunchBox1EditDrink, drinkIndex
                  ) in lunchBox1EditMain.drinks"
                  :key="drinkIndex"
                >
                  <q-input
                    v-model.number="lunchBox1EditDrink.quantity"
                    :label="lunchBox1EditDrink.name"
                    outlined
                    type="number"
                    :input-style="{ fontSize: '20px', margin: '0' }"
                    :label-style="{ fontSize: '20px' }"
            ...
            <div :class="color1" style="width: 100%; padding: 0; margin: 0">
              <h5 style="margin: 0; padding: 0">
                {{ lunchBox1EditSideDishName }}
              </h5>
              <div class="row items-center">
                <q-item
                  v-for="(
                    lunchBox1EditSideDish, index
                  ) in lunchBox1EditSideDishes"
                  :key="index"
                  class="flex-auto"
                  style="margin: 0; padding: 0"
                >
                  <q-input
                    v-model.number="lunchBox1EditSideDish.quantity"
                    :label="lunchBox1EditSideDish.name"
                    outlined
                    type="number"
                    :input-style="{ fontSize: '20px', margin: '0' }"
                    :label-style="{ fontSize: '20px' }"
        ...
        <q-dialog v-model="editDialog6" full-width>
          <q-card>
            ...
            >
              ...
              >
                <h5 style="margin: 0; padding: 0">
                  {{ lunchBox2EditMain.name }}
                </h5>
                <q-input
                  v-model.number="lunchBox2EditMain.quantity"
                  :label="lunchBox2EditMain.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
        ...
        <q-dialog v-model="editDialog7" full-width>
          <q-card>
            ...
            >
              ...
              >
                <h5 style="margin: 0; padding: 0">
                  {{ lunchBox3EditMain.name }}
                </h5>
                <q-input
                  v-model.number="lunchBox3EditMain.quantity"
                  :label="lunchBox3EditMain.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
        ...
        <q-dialog v-model="editDialog8" full-width>
          <q-card>
            ...
            >
              ...
              >
                <h5 style="margin: 0; padding: 0">
                  {{ lunchBox4EditMain.name }}
                </h5>
                <q-input
                  v-model.number="lunchBox4EditMain.quantity"
                  :label="lunchBox4EditMain.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
        ...
        <q-dialog v-model="editDialog0" full-width>
          <q-card>
            ...
            >
              ...
              >
                <h5 style="margin: 0; padding: 0">
                  {{ lunchBoxCustom1EditMain.name }}
                </h5>
                <q-input
                  v-model.number="lunchBoxCustom1EditMain.quantity"
                  :label="lunchBoxCustom1EditMain.name"
                  outlined
                  type="number"
                  :input-style="{ fontSize: '20px', margin: '0' }"
                  :label-style="{ fontSize: '20px' }"
...
const color1 = ref('bg-white')
const color2 = ref('bg-blue-grey-3')

const getBackgroundColor = (index) => {
  if (index % 2 === 0) {
    return 'bg-blue-grey-3' // 偶
  } else {
    return 'bg-white' // 奇
  }
}
...
const eventOptions = ['會議', '教會', '廟會', '婚禮', '喪禮', '生日', '滿月']
...
const getDistrictList = async (id) => {
  try {
    ...
    const response = await apiAuth.get(
      `localization/division/city?filter_parent_id=${id}`
    )
    if (!Array.isArray(response.data)) {
      throw new Error('response.data is not an array')
    }
    address2Options.splice(
      0,
      address2Options.length,
      ...response.data.map((item) => item.name)
    )
  } catch (error) {
    console.error(error)
...
const filterRoadOptions = async (search, update, abort) => {
  try {
    ...
    if (state && district && search.length >= 0) {
      ...
      const cityResponse = await apiAuth.get(
        `/localization/division/city?filter_parent_id=${stateId}`
      )
      ...
      const response = await apiAuth.get(
        `/localization/road?filter_state_id=${stateId}&filter_city_id=${city.city_id}&filter_name=${search}`
      )
      if (!Array.isArray(response.data)) {
        throw new Error('response.data is not an array')
      }
...
watch(
  ...
  async ([state, district], [oldState, oldDistrict]) => {
    ...
    if (
      ...
      (oldDistrict && district !== oldDistrict && !personForm.company)
    ) {
            ...
            if (shouldOverwrite) {
              Dialog.create({
                ...
                .onOk(() => {
                  ...
                  personForm.road2 =
                    res.data[0].address_parts.after_road_section
                })
                .onCancel(() => {
                  // 用户取消时不做任何操作
                })
  ...
  if (search.length > 3) {
    ...
    while (page <= totalPages) {
      const { data } = await apiAuth.get(
        `/member/member?sort=id&order=DESC&filter_phone=${search}&page=${page}`
      )
      ...
      try {
        ...
        if (data.data.length > 0) {
          ...
          const cities = await apiAuth
            .get(
              `localization/division/city?filter_parent_id=${stateObject.id}`
            )
            .then((response) =>
              response.data.find(
...
const getExtraComments2 = async () => {
  try {
    ...
    await new Promise((resolve) => setTimeout(resolve, delay))
    const response = await apiAuth.get(
      '/sale/order/getOrderPhrases/phrase_order_comment'
    )
...
const filteredOption2s = computed(() => {
  ...
  return option2s.value
    .filter((option2) =>
      option2.toLowerCase().includes(searchTerm2.value.toLowerCase())
    )
    .slice(start, end)
})
const totalPage2s = computed(() =>
  Math.ceil(option2s.value.length / ITEMS_PER_PAGE2)
)
watch(
  () => personForm.remark,
  (newVal) => {
...
//     const {
//       data: { total }
//     } = await apiAuth.get('/member/member')
...
//       if (state) {
//         cities = await apiAuth.get(
//           `localization/division/city?filter_parent_id=${state.id}`
//         )
...
//       (c) => c.mobile.replace('-', '') === personForm.tel.replace('-', '')
//     )
...
//         payment_department: personForm.department,
...
const bangdong1TotalQuantity = computed(() => {
  return (
    bangdong1Mains.reduce((total, current) => {
...
const bangdong2TotalQuantity = computed(() => {
  return (
    bangdong2Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const submitBangdong2 = () => {
  ...
  for (const bangdong2Main of bangdong2Mains) {
    if (bangdong2Main.quantity > 0) {
      ...
      row.Main +=
        bangdong2Main.name + 'x' + parseInt(bangdong2Main.quantity).toString()
      // 保留 主餐名稱、主餐ID
      const productInput = {
...
const bangdong3TotalQuantity = computed(() => {
  return (
    bangdong3Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const submitBangdong3 = () => {
  ...
  for (const bangdong3Main of bangdong3Mains) {
    if (bangdong3Main.quantity > 0) {
      ...
      row.Main +=
        bangdong3Main.name + 'x' + parseInt(bangdong3Main.quantity).toString()
      // 保留 主餐名稱、主餐ID
      const productInput = {
...
const bangdong4TotalQuantity = computed(() => {
  return (
    bangdong4Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const submitBangdong4 = () => {
  ...
  for (const bangdong4Main of bangdong4Mains) {
    if (bangdong4Main.quantity > 0) {
      ...
      row.Main +=
        bangdong4Main.name + 'x' + parseInt(bangdong4Main.quantity).toString()
      const productInput = {
...
const loadBangdongVegetarian1 = async () => {
  try {
    ...
    // console.log(bangdongVegetarian1DrinkId.value)
...
const bangdongVegetarian1TotalQuantity = computed(() => {
  return (
    bangdongVegetarian1Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
  ...
  for (const bangdongVegetarian1Main of bangdongVegetarian1Mains) {
    if (bangdongVegetarian1Main.quantity > 0) {
      ...
      row.Main +=
        ...
        'x' +
        parseInt(bangdongVegetarian1Main.quantity).toString()
      // 保留 主餐名稱、主餐ID
      const productInput = {
...
const bangdongVegetarian2TotalQuantity = computed(() => {
  return (
    bangdongVegetarian2Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const submitBangdongVegetarian2 = () => {
  ...
  for (const bangdongVegetarian2Drink of bangdongVegetarian2Drinks) {
    if (bangdongVegetarian2Drink.quantity > 0) {
      ...
      console.log(bangdongVegetarian2DrinkId.value)
      row.productInputs.push(productInput)
      const input = {
...
const lunchBox1TotalQuantity = computed(() => {
  return (
    lunchBox1Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox2TotalQuantity = computed(() => {
  return (
    lunchBox2Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox3TotalQuantity = computed(() => {
  return (
    lunchBox3Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox4TotalQuantity = computed(() => {
  return (
    lunchBox4Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const bangdongCustom1TotalQuantity = computed(() => {
  return (
    bangdongCustom1Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBoxCustom1TotalQuantity = computed(() => {
  return (
    lunchBoxCustom1Mains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const submitBangdongSolo = () => {
  ...
  if (bangdongSolo3inchCompositions.length > 0) {
    ...
    }  (${bangdongSolo3inchCompositions.join(', ')})`
  }
...
const bangdong1EditTotalQuantity = computed(() => {
  return (
    bangdong1EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const bangdong2EditTotalQuantity = computed(() => {
  return (
    bangdong2EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const bangdong3EditTotalQuantity = computed(() => {
  return (
    bangdong3EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
function saveEditDialog3 () {
  ...
  if (bangdong3EditArbitrarily.value > 0) {
    ...
    row.Main +=
      '任意搭配' + 'x' + parseInt(bangdong3EditArbitrarily.value).toString()
    const input = {
...
const bangdong4EditTotalQuantity = computed(() => {
  return (
    bangdong4EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const bangdongVegetarian1EditTotalQuantity = computed(() => {
  return (
    bangdongVegetarian1EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const bangdongVegetarian2EditTotalQuantity = computed(() => {
  return (
    bangdongVegetarian2EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
function editRowDialog9 (row) {
  ...
  bangdongCustom1EditPrice.value =
    totalQuantity / bangdongCustom1EditTotalQuantity.value // 将 rowPrice / totalQuantity 的值赋给 bangdongCustom1EditPrice
...
const bangdongCustom1EditTotalQuantity = computed(() => {
  return (
    bangdongCustom1EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox1EditTotalQuantity = computed(() => {
  return (
    lunchBox1EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox2EditTotalQuantity = computed(() => {
  return (
    lunchBox2EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox3EditTotalQuantity = computed(() => {
  return (
    lunchBox3EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const lunchBox4EditTotalQuantity = computed(() => {
  return (
    lunchBox4EditMains.reduce((total, current) => {
      return total + parseInt(current.quantity)
...
const addOrder = async () => {
  ...
  try {
    ...
    const formattedDate3 =
      year3 && month3 && day3 ? year3 + '-' + month3 + '-' + day3 : '' // 確保所有日期部分都存在才組成日期字串
    ...
    formData.append(
      'delivery_date_hi',
      personForm.time.replace(':', '').substring(0, 4)
    ) // 送達時間
...
watch(() => personForm.getDate, (newDate, oldDate) => {
