  ...
  actions: {
    ...
    async createInvoice (val) {
      ...
      try {
        ...
        this.form.is_payment_tin = this.searchInvoice.is_payment_tin
        this.form.paymentNumber = this.searchInvoice.payment_tin
    ...
    async sentInvoice () {
      ...
      try {
        ...
        if (this.form.is_payment_tin === 1) {
          this.form2.phone = this.form.paymentNumber
        } else {
          this.form2.phone = ''
        }
